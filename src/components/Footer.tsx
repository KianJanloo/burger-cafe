      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6">{t('menuCategories')}</h3>
            <ul className="space-y-3">
              <li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6">{t('contactInfo')}</h3>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 mt-4 md:mt-0 justify-center md:justify-end">
              <a href="#" className="text-gray-400 hover:text-red-400 text-xs sm:text-sm transition-colors duration-300">
                {t('privacy')}
              </a>
              <a href="#" className="text-gray-400 hover:text-red-400 text-xs sm:text-sm transition-colors duration-300">
                {t('terms')}
