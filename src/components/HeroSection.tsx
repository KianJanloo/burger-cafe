...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen max-md:py-8 flex items-center justify-center overflow-hidden bg-gradient-to-br from-red-50 to-orange-50 dark:from-gray-900 dark:to-gray-800">
      {/* Background Pattern */}
